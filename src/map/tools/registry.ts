...
/// registry). Adding a tool (Phase 6 walls/lights) = one module + one entry here.
/// </summary>
export const MAP_TOOLS: MapTool[] = [selectTool, measureTool, drawTool, calibrateTool, fogTool];
